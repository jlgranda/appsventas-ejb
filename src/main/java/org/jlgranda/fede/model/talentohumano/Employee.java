...
@NamedQueries({
    ...
    @NamedQuery(name = "Employee.findByorganizationAndOwnerCodeAndName", query = "SELECT e FROM Employee e WHERE e.organization = :organization and (lower(e.owner.code) like lower(:code) or lower(e.owner.firstname) like lower(:firstname) or lower(e.owner.surname) like lower(:surname))")
})
